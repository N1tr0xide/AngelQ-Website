...
const STAR_TAIL_SIZE = 0.5;
const STAR_MOVE_MULTIPLIER = 0.5;
...
function recycleStar(star) {
    ...
    if (vx > 1 || vy > 1) 
    {
        ...
        {
            direction = velocity.y > 0 ? "top" : "bottom";
        }
    }
...
function update() {
    velocity.tx *= STAR_MOVE_MULTIPLIER;
    velocity.ty *= STAR_MOVE_MULTIPLIER;
